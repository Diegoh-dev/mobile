...
export default function NewMemory() {
 ...
 async function openImagePicket(){

  try{
    let result = await ImagePicker.launchImageLibraryAsync({
      mediaTypes: ImagePicker.MediaTypeOptions.Images,//fazer a parte de video
      quality: 1,
    });
...
// para deletar o token e logar novamente
  // return
